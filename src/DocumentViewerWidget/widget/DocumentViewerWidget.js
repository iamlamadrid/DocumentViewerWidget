require([
    ...
    "dojo/_base/window",
    "dojo/text",
    "dojo/text!DocumentViewerWidget/widget/templates/DocumentViewerWidget.html"
    ...
    return declare("DocumentViewerWidget.widget.DocumentViewerWidget", [_WidgetBase, _TemplatedMixin], {
        ...
        _updateRendering: function (callback) {
            ...
            if (this._contextObj && this._contextObj.get("HasContents")) {
                if (this._usePDFjs /* && this._contextObj.get("Name").indexOf(".pdf") !== -1*/ ) {
                    var pdfJSViewer = require.toUrl("DocumentViewerWidget/lib/pdfjs/web/viewer.html").split("?")[0],
                ...
                domAttr.set(this.iframeNode, "src", require.toUrl("DocumentViewerWidget/widget/ui/blank.html"));
        ...
        _getFileUrl: function () {
            ...
            if (this._contextObj === null || this._contextObj.get("Name") === null) {
                return require.toUrl("DocumentViewerWidget/widget/ui/error.html");
            } else {
